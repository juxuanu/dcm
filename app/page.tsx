import EmailLogo from "../components/email-logo.tsx";
import Footer from "../components/footer.tsx";
import Header from "../components/header.tsx";
import InstagramLogo from "../components/instagram-logo.tsx";
import LinkedInLogo from "../components/linkedin-logo.tsx";
    ...
    <>
      ...
      <Section title="Què?">
        ...
        <p>
          ...
          , com a regal per l&apos;
          <Link.default className="underline" href="mailto:dcm@icarns.xyz">
            Ícar
          </Link.default>
          .
        </p>
        <div className="my-6 flex h-auto w-full flex-row flex-nowrap gap-3 overflow-x-auto *:h-auto *:w-72">
          <Link.default href="/llibret1.jpeg" prefetch={false}>
            <Picture.default
              src={llibret1}
          ...
          <Link.default href="/llibret2.jpeg" prefetch={false}>
            <Picture.default
              src={llibret2}
          ...
          <Link.default href="/llibret3.jpeg" prefetch={false}>
            <Picture.default
              src={llibret3}
            ...
            <StringPair
              ...
              extraElement={
                <div className="flex h-fit w-fit flex-row gap-1">
                  ...
                  <Link.default href="mailto:dcm@icarns.xyz" title="E-Mail">
                    <EmailLogo />
                  </Link.default>
                </div>
              }
      ...
      <Section title="On?" extraClasses="mt-6">
        ...
        <ul className="list-inside list-disc">
          <li>
            ...
            <Link.default
              className="underline"
              href="https://s3.amazonaws.com/media.ib3alacarta.com/058decc8-4b98-4f6f-b3b4-9b2984825171/da217664-1bdf-11ee-a224-c437725f29d4/DLT8706291.mp4"
              target="_blank"
              prefetch={false}
            >
              Cinc dies
          ...
          <li>
            ...
            <Link.default
              className="underline"
              target="_blank"
              href="https://s3.amazonaws.com/media.ib3alacarta.com/eeeeb5c0-1941-4e25-884d-91010e713d8d/db3060aa-1737-11ee-a224-c437725f29d4/6-422-121478.mp3"
              prefetch={false}
            >
              Ràdio
            </Link.default>{" "}
          ...
          <li>
            <Link.default
              className="underline"
              target="_blank"
              href="https://www.arabalears.cat/cultura/catalunya-nyonya-mallorca-xubec-diccionari-mallorquina-fet-catala_1_4740442.html"
              prefetch={false}
            >
              ARA Balears
            </Link.default>
          ...
          <li>
            <Link.default
              className="underline"
              target="_blank"
              href="https://www.elnacional.cat/ca/estil-vida/paraules-diferents-mallorqui-catala_1260374_102.html"
              prefetch={false}
            >
              El Nacional
            </Link.default>
